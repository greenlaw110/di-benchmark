...
public class StopWatch {
    ...
    public static void millis(String description, Runnable runnable) {
        ...
        System.out.println(String.format("%20s|%6sms", description, end - start));
    }
    ...
    public static void startAndFetch(String description, StartAndFetch runnable) {
        ...
        System.out.println(String.format("%20s| start:%6sms   fetch:%6sms", description, startup.get(), fetch.get()));
    }
}
